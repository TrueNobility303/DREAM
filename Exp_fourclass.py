...
parser.add_argument('--data_file', default='fourclass', type=str, help='file of data')
...
parser.add_argument('--epochs', default=10, type=int, help='number of epochs (one pass of data)')
